...
const Overview = ({ userSettings }: { userSettings: UserSettings }) => {
  ...
  return (
    <>
      <div className="container flex flex-wrap items-end justify-between gap-2 py-4 px-4 mx-auto">
      ...
      <div className="container flex w-full flex-col gap-2 px-4 mx-auto">
        <StatsCards
